...
# from .base_training_loop_instanceloss import base_training_loop
...
def train(
    ...
    for e in range(1 + restore_epoch, config.experience.max_iter + 1):# [1,101)
        ...
        if (config.experience.test_eval_freq > -1) and ((e % config.experience.test_eval_freq == 0) or (e == config.experience.max_iter)):
            ...
            dataset_dict["drone_drone"]["query"] = test_dts['drone']
            dataset_dict["drone_drone"]["gallery"] = test_dts['drone']
            dataset_dict["satellite_satellite"]["query"] = test_dts['satellite']
            dataset_dict["satellite_satellite"]["gallery"] = test_dts['satellite']
